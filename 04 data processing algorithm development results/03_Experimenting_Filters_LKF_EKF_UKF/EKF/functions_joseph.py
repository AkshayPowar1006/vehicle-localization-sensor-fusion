# -*- coding: utf-8 -*-
"""
Created on Tue May 30 14:17:17 2023
...
def next_state_JosephModel(previous_state,dt):
    x_t_0 = previous_state[0]
    y_t_0 = previous_state[1]
    v_t_0 = previous_state[2]
    theta_t_0 = previous_state[3]
    a_t_0 = previous_state[4]
    theta_dot_t_0 = previous_state[5]
    ...
    next_state = np.array([x_t_1, y_t_1, v_t_1, theta_t_1, a_t_1, theta_dot_t_1]).reshape(len(previous_state),1)
