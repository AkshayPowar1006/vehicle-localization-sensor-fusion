...
if __name__ == '__main__':       
    ...
    fig, ((ax1, ax2, ax5)) = plt.subplots(1, 3, figsize=(10.5, 3.5))
    ...
    ax5.plot(true_mean_vehicle[3,:,updatesteps], 'ko--', label = "True")
    #ax5.plot(mean_after_prediction[3,:,updatesteps], color='indigo', marker = 'o', linestyle='--', label = "Pred")
    ax5.plot(mean_after_gps_update[3,:,updatesteps], color='salmon', marker = 'o', linestyle='--', label = "Corr")
    ax5.legend(loc='center right')
    ax5.set_ylabel('Heading Change in rad/s')
