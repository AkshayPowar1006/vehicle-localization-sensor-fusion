...
measu_inputs = 2
control_inputs = 2
df = pd.read_csv("../Sort Arduino Data by Time Stamps/megadatabase_path3_28032023.csv")
...
init_state_ekf1 = np.array([681541, 5406051, 1.2, 0.005]).reshape(num_states_ekf1,1)
init_state_ukf = np.array([681670, 5406051, 1.2, 0.005]).reshape(num_states_ukf,1)
